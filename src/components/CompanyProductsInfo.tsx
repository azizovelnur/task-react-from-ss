  ...
  return (
    <div className="px-[27px]">
      {companyProductsInfoFromSlice.map((el, key) => (
        <div
          key={key}
          className="bg-white mt-2 rounded-[5px] h-[62px] flex  items-center pl-[62px] border-2 border-[#EFF0F4] relative"
        >
          ...
          <div className="w-[101px] mr-[90px]">
            ...
            <div className="text-[#0C47B7] underline">{el.trackingNumber}</div>
          </div>
